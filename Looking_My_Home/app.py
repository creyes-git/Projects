...
def avg_price_size_bed_bath_mdays(dataframe):
    ...
    with st.container():
        ...
        col1.markdown("Avg Price: ", f"# :red[{str(avg_price)}]")
        col2.markdown("Avg Size: ", f"# :green[{str(avg_size)}]")
        col1.markdown("Avg baths/beds: ", f"# :yellow[{str(avg_beds)}]")
        col2.markdown("Avg Days on Market: ", f"# :orange[{str(avg_days_market)}]")
