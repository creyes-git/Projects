...
def get_url_img(url):
   ...
   no_img = ImageReader(r"images/no_picture_url.png")
...
def gen_pdf(sku, brand, name, upc = " ", finish = " ", collection = " ",
   ...
   try:
      pdf = canvas.Canvas(fr"data/saved_pdf/Speec_sheet-{sku}.pdf", pagesize=letter)
   except:
   ...
   try:
      logo = ImageReader(fr"images/{brand}.png")
