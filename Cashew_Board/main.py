...
with st.sidebar:
    ...
    cashew_csv_file = st.file_uploader(label = "Upload Your Cashew CSV Data Here", type = ["csv"], accept_multiple_files = False, help = "Go to Cashew App > Settings > Export Data > Export CSV")
...
if df:
    ...
    c2.image("assets/images/no-search-filter.png", use_container_width = True, clamp = True)