...
def landing_page():
    ...
    c2.image(Image.open("Naruto_app/wp4981533-naruto-minimal-wallpapers.png"), width=200, clamp=True)
    c3.image(Image.open("Naruto_app/wp4981538-naruto-minimal-wallpapers.png"), width=200, clamp=True)
