...
def landing_page():
    ...
    c1.image(Image.open("Naruto_app/wp2725528-naruto-kakashi-wallpaper.png"), width=120, clamp=True)
    c3.image(Image.open("Naruto_app/Landing Page.png"), width=120, clamp=True)
    c2.image(Image.open("Naruto_app/wp10367350-minato-minimalist-wallpapers.jpg"), width=120, clamp=True)
    c5.image(Image.open("Naruto_app/wp5129198-anime-lambang-uciha-wallpapers.jpg"), width=120, clamp=True)
    c4.image(Image.open("Naruto_app/wp10926937-minimalist-4k-naruto-wallpapers.png"), width=120, clamp=True)
