...
def landing_page():
    ...
    c2 = st.image(Image.open("Naruto_app/wp4981533-naruto-minimal-wallpapers.png"), use_column_width= True)
    c3 = st.image(Image.open("Naruto_app/wp4981535-naruto-minimal-wallpapers.jpg"), use_column_width= True)
