...
st.image(Image.open("Naruto_app//images//Land_of_Earth_Symbol.png"),caption="The Land of Earth",  width=150)
...
st.image(Image.open("Naruto_app//images//Land_of_Iron_Symbol.png"),caption="The Land of Iron")
...
st.image(Image.open("Naruto_app//images//Land_of_Lightning_Symbol.png"),caption="The Land of Lightning")
...
st.image(Image.open("Naruto_app//images//Land_of_Snow_Symbol.png"),caption="The Land of Snow")
...
st.image(Image.open("Naruto_app//images//Land_of_Sound_Symbol.png"),caption="The Land of Sound")
...
st.image(Image.open("Naruto_app//images//Land_of_Water_Symbol.png"),caption="The Land of Water")
...
st.image(Image.open("Naruto_app//images//Land_of_Wind_Symbol.png"),caption="The Land of Wind")
