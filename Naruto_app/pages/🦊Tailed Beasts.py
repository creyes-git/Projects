...
st.title("Abilities")
st.markdown("As a tailed beast, Shukaku possesses a large quantity of chakra and can perform the Tailed Beast Ball. As a precaution, if its jinchūriki lost control and fully transformed into Shukaku inside of Suna, the villagers were to either evacuate beforehand or seek shelter due to the risk of mass casualty from its rampage. Shukaku has the ability to control its jinchūriki whenever they sleep, leading its host to develop insomnia. Shukaku has great physical strength while using its tail, as seen when overlapping it with the other tailed beasts to shatter and even obliterate a senjutsu-enhanced humanoid Susanoo. Shukaku's power is quite impressive to the likes of the Ōtsutsuki Clan, with Urashiki Ōtsutsuki expressing glee in taking it.")
st.markdown('''Sand Manipulation: Shukaku enforcing a fūinjutsu with its curse seal markings.
...
st.title("Abilities")
st.markdown("As a tailed beast, Son Gokū possesses an enormous supply of chakra and can create the Tailed Beast Ball. Son also seems knowledgeable in taijutsu, likewise showing deceptive nimbleness of its size, utilising powerful and well-timed kicks against its opponents. Son has a great deal of physical strength, being able to lift and toss Gyūki with ease.")
...
st.title("Abilities")
st.markdown("As a tailed beast, Kokuō possesses a massive amount of chakra and can use it to create a Tailed Beast Ball. Its willpower was incredibly strong, as it was the only tailed beast who broke free, albeit briefly, of Tobi's control and attempted to attack the masked man. Kokuō also possesses great physical strength and uses its horns in combat, showing enough ramming-force to injure and knock Gyūki a considerable distance away.")
st.markdown("Nature Transformation: By combining water and fire-natured chakra to create Boil Release, Kokuō is able to increase the temperature of its chakra to its boiling point. This ability forms the basis of what is referred to as steam-based ninjutsu, granting itself, or its jinchūriki, overwhelming physical strength. When in use, this ability causes the jinchūriki to emit copious amounts of steam from their body.")
...
st.title("Abilities")
st.markdown("Gyūki was noted by Kisame and Kurama to be the second most powerful of the nine tailed beasts. Even the Third Raikage, hailed as the greatest shinobi in Kumo's history, formed a special team to subdue and seal it during its various rampages, with the ushi-oni fighting the Third to a stalemate on one occasion. The Fourth Raikage also once forbade B from fully transforming into Gyūki due to its great power. During the Fourth Shinobi World War, Gyūki held its own against two other tailed beasts despite suffering a past injury.")
st.markdown("Chakra and Physical Prowess: As a tailed beast, Gyūki possesses a massive supply of powerful chakra and can share it with others. It can replenish its high reserves shortly after an entire day's usage. Should the need arise, it can disturb B's chakra with its own to dispel powerful genjutsu. Gyūki's tentacles, if severed, can be used as a medium for its chakra, such as creating a clone of its host, or transferring chakra to said host should the beast be extracted.")
st.markdown("Ninjutsu: Gyūki can perform the Tailed Beast Ball, being able to fire it normally, consecutively or as a massive wave. It is strong enough to devastate an entire valley, penetrate nine barriers without exploding, and even push the Ten-Tails' own Tailed Beast Ball back intoits body. Unlike most tailed beasts, Gyūki can supercharge it, creating one many times its own size for much greater power. Going with its octopus theme, it can produce ink to blind its enemies or form ink clones to seal them.")
...
st.title("Abilities")
st.markdown("Kurama was widely known as the strongest of the nine tailed beasts. Hashirama Senju, who could subdue the fox, viewed it as too powerful and dangerous to be left roaming free. Even with only half its power, Kurama remained strong enough to defeat five other tailed beasts at the same time. After the Fourth Shinobi World War, Kurama's full power was restored once its two halves reunited inside Naruto, allowing it to defeat Toneri's giant golem and Momoshiki Ōtsutsuki's elemental construct. The absolute peak of its power allowed it to even decisively overwhelm Isshiki Ōtsutsuki. Kurama later became able to manifest itself outside of Naruto, allowing the two to fight independently and away from each other.")
st.markdown('''Chakra and Physical Prowess: Kurama possessed vast and powerful chakra, the most of the nine tailed beasts alongside Gyūki, and was required to be sealed last into the Demonic Statue of the Outer Path to avoid overloading it. It could also accumulate a huge amount of chakra shortly after it has used up most of its own, enough to be passed on to the entire Allied Shinobi Forces and be felt countries away by non-sensors. Due to Naruto's compatibility with Kurama's chakra, any chakra it possessed is limited for its jinchūriki alone, unless it was moulded to fit the recipient's unique chakra signature. When used by others, the chakra became dense enough to be seen as a visible shroud than can further protect the wearer. Using its chakra, Kurama could shroud itself within its Nine-Tails Chakra Mode to increase its power. As a last-ditch ability''')
